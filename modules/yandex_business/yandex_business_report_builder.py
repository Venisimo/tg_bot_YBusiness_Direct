# modules/yandex_business/yandex_business_report_builder.py
import asyncio
    ...
    async def fetch_detailed_statistics(self, account: Account, date_from: str, date_to: str):
        ...
        mock_campaigns = [
            ...
            },
            {
                ...
                "paused": "Нет",
                "mapsOnly": "Да",
                "url": "https://yandex.ru/business/3",
            },
        ]
        ...
        for campaign in mock_campaigns:
            ...
            if campaign["remainingDays"] < 10:
                warning = "\n⚠️ *Внимание!* До окончания кампании осталось меньше 10 дней!"
